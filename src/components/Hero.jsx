...
const Hero = () => {
  ...
  useGSAP(() => {
    gsap.set('#video-frame', {
      ...
      // clipPath: "polygon(23% 0, 73% 8%, 85% 90%, 0 63%)",
  ...
  return (
    <div className="relative h-dvh w-screen overflow-x-hidden">
      ...
      ">
        {/* border-solid border-black border-1 */}
        <div>
        ...
        <div className="absolute left-0 top-0 z-40 size-full">
          <div className="mt-24 px-5 sm:px-10">
            ...
            {/* Note ! is used when different classes are combined 
            and to specify which is more important and resolve ambiguity
            (or) can use 'clsx' */}
          </div>
        </div>
      </div>
